  ...
  return (
    ...
    <Header></Header>
      <section id='1' className="h-screen w-full section-1 md:grid md:grid-cols-2">
        <div className="flex flex-col justify-center items-center gap-4 md:gap-8 mt-8 md:mt-0">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl mt-20 md:mt-0">From Our Garden to Yours</h2>
          <p className="w-full sm:w-1/2 md:w-3/4 px-8 sm:px-4 md:px-2 text-center">
        ...
        <div className="w-4/6 sm:w-1/2 md:w-5/6">
            <Image 
      ...
      <section id='2' className="h-auto section-2 px-4 mb-32">
        <h2 className="mt-24 text-2xl sm:text-3xl md:text-4xl text-center">The Seeds</h2>
      ...
      <section id='3' className="h-auto section-3">
      </section>
      <section id='4' className="section-4 h-screen">
      <h1 className="pt-32 text-2xl sm:text-3xl md:text-4xl text-center">JOIN WAITLIST</h1>
       <Form  />
      </section>
      <Footer />
    </main>
